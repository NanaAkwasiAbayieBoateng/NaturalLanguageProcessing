...
chapters_lda_td%>%head()
```


Notice that this has turned the model into a one-topic-per-term-per-row format. For each combination the model has β
β
, the probability of that term being generated from that topic.
